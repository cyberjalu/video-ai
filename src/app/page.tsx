      ...
      <HomeMotion>
        <section className="relative grid items-end gap-10 pt-2 lg:grid-cols-[1.2fr_0.8fr] lg:gap-12 lg:pt-4">
          <div className="relative z-10 max-w-xl">
            ...
            <h1 className="gsap-hero display-title text-[clamp(3rem,9vw,5.25rem)] leading-[0.88] text-[var(--ink)]">
              ClipNews
            </h1>

            <p className="gsap-hero mt-5 max-w-[34ch] text-[15px] leading-relaxed text-[var(--ink-muted)] md:text-[16px]">
          ...
          {heroTpl ? (
            <div className="gsap-phone relative mx-auto w-full max-w-[240px] lg:mr-2 lg:ml-auto">
        ...
        <section className="mt-14 md:mt-16">
          ...
          <div className="gsap-strip filmstrip -mx-1">
            {featured.map((tpl) => (
              <div key={tpl.id} className="filmstrip-frame">
                <Link
        ...
        <section className="gsap-section mt-12 border-t border-[var(--line-soft)] pt-8 md:mt-14">
